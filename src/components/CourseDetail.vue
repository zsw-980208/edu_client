        ...
        <div class="main">
            <div class="course-info">
                ...
                <div class="wrap-right">
                    ...
                    <p class="data">{{course.students}}人在学&nbsp;&nbsp;&nbsp;&nbsp;课程总时长：{{course.lessons}}课时/{{course.pub_lessons}}小时&nbsp;&nbsp;&nbsp;&nbsp;难度：{{course.level_name}}</p>
                    <div class="sale-time">
            ...
            <div class="course-tab">
                <ul class="tab-list">
                    ...
                    <li :class="tabIndex==3?'active':''" @click="tabIndex=3">用户评论 ({{msg_list.length}})</li>
                ...
                <div class="course-tab-list">
                    ...
                    <div class="tab-item" v-if="tabIndex==2">
                        <div class="tab-item-title">
                            ...
                            <p class="chapter-length">共{{chapters.length}}章 {{course.lessons}}个课时</p>
                        </div>
                        <div class="chapter-item" v-for="chapter in chapters">
                            ...
                            <ul class="lesson-list">
                                <li class="lesson-item" v-for="(lesson,index) in chapter.lesson_list">
                    ...
                    <div class="tab-item" v-if="tabIndex==3">
                        ...
                        <input type="text" v-model="msg">
                         <button @click="add_note">添加评论</button>
                        <br>
                        <ul>
                ...
                <div class="course-side">
                    <div class="teacher-info">
                        ...
                        <div class="teacher-content">
                            <div class="cont1">
                                <img :src="'http://127.0.0.1:8000/'+course.teacher.image" alt="">
                                <div class="name">
    ...
    export default {
        ...
        methods: {
            ...
            get_onecourse() {
                ...
                this.$axios({
                    url: "http://127.0.0.1:8000/course/course_one/" + `${course_id}`,
                    method: "get"
                }).then(res => {
                    console.log(res.data.results);
                    this.course = res.data.results;
                    this.playerOptions.sources[0].src = "http://127.0.0.1:8000/" + res.data.results.course_video;
                    this.playerOptions.poster = "http://127.0.0.1:8000/" + res.data.results.course_img;
            ...
            get_lessons() {
                ...
                this.$axios({
                    url: "http://127.0.0.1:8000/course/chapters/" + `${course_id}`,
                    method: "get"
                }).then(res => {
                    console.log(res.data.results);
                    this.chapters = res.data.results;
                }).catch(error => {
                    this.$message.error("查询出错了");
                })
            },
            ...
            delMsg(index) {
                ...
                console.log(index);
                console.log(JSON.parse(localStorage.msgs)[index])
                localStorage.msgs = JSON.stringify(this.msg_list)
            },
            check_user_login() {
            ...
            addCart(){
              ...
              this.$axios.post(`http://127.0.0.1:8000/cart/option/`,{
                ...
                console.log(response.data.course_len);
                this.$store.commit("add_cart",response.data.course_len)
              }).catch(error=>{
